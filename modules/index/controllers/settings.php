...
class Controller extends ApiController
{
    ...
    private function getCompanyData()
    {
        ...
        $result = [
            ...
            'company_allowno' => $company['allowno'] ?? '',
    ...
    private function parseGeneralSettings($body, $config)
    {
        ...
        $boolKeys = ['activate_user', 'cookie_policy', 'demo_mode', 'new_members_active', 'user_forgot', 'user_register'];
    ...
    private function parseCompanySettings($body, $config)
    {
        ...
        $config->company['allowno'] = Text::topic($body['company_allowno'] ?? '');
