...
class Controller extends ApiController
{
    ...
    public function get(Request $request)
    {
        try {
            ...
            return $this->successResponse([
                'data' => (object) [
                    'booking_calendar_status' => self::$cfg->booking_calendar_status,
    ...
    public function save(Request $request)
    {
        try {
            ...
            $config->booking_calendar_status = $request->post('booking_calendar_status', [])->toInt();
            if (empty($config->booking_calendar_status)) {
                $config->booking_calendar_status = [Helper::STATUS_APPROVED];
            }
