...
--
-- Table structure for table `{prefix}_login_attempt`
--
...
--
-- Indexes for table `{prefix}_login_attempt`
--
ALTER TABLE `{prefix}_login_attempt`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `{prefix}_login_attempt`
--
ALTER TABLE `{prefix}_login_attempt`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Table structure for table `{prefix}_user_session`
